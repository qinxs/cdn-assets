!function(e, t, a) {
    ...
    function n() { c(".heart{width: 12px;height: 12px;position: fixed;background: #f00;transform: rotate(45deg);-webkit-transform: rotate(45deg);-moz-transform: rotate(45deg);}.heart:after,.heart:before{content: '';width: inherit;height: inherit;background: inherit;border-radius: 50%;-webkit-border-radius: 500%;-moz-border-radius: 50%;position: fixed;}.heart:after{top: -5px;}.heart:before{left: -5px;}"), o(), r() }
    ...
    function o() {
        var _t = "function" == typeof e.onclick && e.onclick;
        t.onclick = function(e) { _t && _t(), i(e) }
    }
